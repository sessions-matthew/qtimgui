  ...
  void paintGL() override
  {
    ...
    if (ImGui::Begin("Example: Fullscreen window", nullptr, flags)) {
      ...
      if (ImPlot::BeginPlot("##guides", 0, 0, ImVec2(-1, -1), ImPlotFlags_YAxis2)) {
        // ImPlot::DragLineX(0, &x1, show_labels);
        // ImPlot::DragLineX(1, &x2, show_labels);
        // ImPlot::DragLineY(2, &y1, show_labels);
        // ImPlot::DragLineY(3, &y2, show_labels);
        ...
        // ImPlot::DragLineY(4, &f, show_labels, ImVec4(1, 0.5f, 1, 1));
        ImPlot::EndPlot();
      }
    }
    ImGui::End();
